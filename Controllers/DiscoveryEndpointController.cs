...
public class DiscoveryEndpointController : Controller
{
    ...
    {
        return Json(new DiscoveryResponse
            {
                issuer = "https://localhost:7275",
                authorization_endpoint = "https://localhost:7275/Auth/Authorize",
                token_endpoint = "https://localhost:7275/Auth/Token",
